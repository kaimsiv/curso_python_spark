Aquí tienes el manual de la **Práctica 9 completamente actualizado**. Se ha integrado un set de datos de **10 registros mínimos** reales y consistentes para cada archivo de origen, y se han reestructurado todos los scripts en Python añadiendo el silenciado de logs (`spark.sparkContext.setLogLevel("ERROR")`), la paleta de colores ANSI uniforme y los separadores de bloques para garantizar impresiones impecables y ordenadas en la terminal de VS Code.
...
### Paso 1. Crear el script de rendimiento
...
### Paso 1. Inspeccionar planes lógicos y físicos
...
print("\n" + "="*60)
print(f"{BOLD}{YELLOW}⚙️  TAREA 4: INSPECCIÓN DE PLANES OPTIMIZADOS (CATALYST OPTIMIZER){RESET}")
print("="*60)
...
### Paso 1. Ejecutar el flujo completo optimizado
